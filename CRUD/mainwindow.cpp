...
void MainWindow::on_qrcodegen_clicked()
{
    int tabeq=ui->tab_client->currentIndex().row();
           ...
           qry.exec();
              QString  iden,nom,adresse,nbreticket,destination,abonnement ,ide;
           ...
           ide=QString(id);
                  ide="CIN:"+ide+"ID:"+iden+"NOM:"+nom+"ADRESSE:"+adresse +"NBRE_TICKET:"+nbreticket+"DESTINATION:"+destination+"ABONNEMENT:"+abonnement;
...
void MainWindow::on_statsmed_clicked()
{
    QSqlQueryModel * model= new QSqlQueryModel();
     ...
     QString a = QString("rades  "+QString::number((number1*100)/total,'f',2)+"%" );
