...
{//bool test=false;
    QSqlQuery query;
          ...
          query.prepare("INSERT INTO REPARATION (ID_REPARATION, PIECE,PANNE, DATE_DISPO,DATE_DEBUT,FACTURE,EMAIL) "
                        "VALUES (:ID_REPARATION, :PIECE,:PANNE,:DATE_DISPO,:DATE_DEBUT, :FACTURE,:EMAIL )");
